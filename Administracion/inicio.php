<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div id="contenido">
    ...
    <table class="table">
      ...
      </thead><main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Pagina de Inicio</h1>
  </div>
  <div id="contenido">
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          <td><button class="btn btn-primary" onclick="location.href='/Digimon/Administracion/views/user/list.php'">Listar Usuarios</button></td>
        ...
        <tr>
          <td><button class="btn btn-primary" onclick="location.href='/Digimon/Administracion/views/digimon/show.php'">Ver Digimones</button></td>
